                ...
                <div class="w-full">
                    <div class="sm:flex sm:items-center">
                        <div class="sm:flex-auto">
                            <h1 class="text-base font-semibold leading-6 text-gray-900">{{ __('Ubah Peminjaman') }}</h1>
                            <p class="mt-2 text-sm text-gray-700">Perbarui detail transaksi peminjaman dan denda.</p>
                        </div>
                    ...
                    <div class="flow-root">
                        <div class="mt-8 overflow-x-auto">
                            <div class="max-w-xl py-2 align-middle">
                                <form method="POST" action="{{ route('peminjaman.update', $peminjaman->id_pinjam) }}" role="form">
                                    @method('PATCH')
                                    @csrf
